...
// @formatter:off
    ...
    {
        var sensorSize = camera.Lens.PhysicalProperties.SensorSize.y;
        var currentFocalLength = VerticalFOVToFocalLength(camera.Lens.FieldOfView, sensorSize);
        ...
        while (elapsed < duration)
        {
            ...
            camera.Lens.FieldOfView = currentLerpedFOV;
